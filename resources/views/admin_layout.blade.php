                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li><a href="{{ URL::to('/show-info-admin') }}"><i class=" fa fa-suitcase"></i>Thông tin</a>
                            </li>
                            <li><a href="{{URL::to('/edit-admin') }}"><i class="fa fa-cog"></i> Cài đặt</a></li>
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/manage-coupon')}}">Quản lí mã giảm giá</a></li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/manage-customer')}}">Quản lí Khách Hàng</a></li>
